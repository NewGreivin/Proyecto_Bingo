...
public class DlgSelectorModo extends javax.swing.JDialog {
    ...
    private SeleccionModoJuego seleccionModo;

    public DlgSelectorModo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicializarComboVictoria();
    }
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!btnAutomatico.isSelected() && !btnManual.isSelected()) {
            javax.swing.JOptionPane.showMessageDialog(
                this,"Por favor selecciona un modo de juego (Automático o Manual)","Selección requerida",
                javax.swing.JOptionPane.WARNING_MESSAGE);
            return;
        }
        
        if (txtVictoriaJuego.getSelectedItem() == null || 
            txtVictoriaJuego.getSelectedItem().toString().trim().isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(
                this,"Por favor selecciona un tipo de victoria","Selección requerida",JOptionPane.WARNING_MESSAGE);
            return;
        }
        boolean esAutomatico = btnAutomatico.isSelected();
        String tipoVictoria = txtVictoriaJuego.getSelectedItem().toString();
        
        this.seleccionModo = new SeleccionModoJuego(esAutomatico, tipoVictoria);
        this.dispose();
    }

    public SeleccionModoJuego getSeleccionModo() {
        return seleccionModo;
    }

    private void inicializarComboVictoria() {
        txtVictoriaJuego.addItem("Victoria Normal");
        txtVictoriaJuego.addItem("Cuatro Esquinas");
        txtVictoriaJuego.addItem("Carton Lleno");
        txtVictoriaJuego.setSelectedIndex(0);
    }
