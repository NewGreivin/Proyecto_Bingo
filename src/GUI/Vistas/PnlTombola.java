...
public class PnlTombola extends javax.swing.JPanel implements TombolaObserver {
    ...
    private void inicializarComponentes() {
        ...
        if (esAutomatico) {
            // Modo automático: habilitar solo el botón Generar
            txtIngresarNumero.setEnabled(false);
            btnCantar.setEnabled(false);
            btnCantar.setOpaque(false);
            btnGenerar.setEnabled(true);
        } else {
            // Modo manual: habilitar ingreso de número y botón Cantar
            txtIngresarNumero.setEnabled(true);
            txtIngresarNumero.setText("");
            btnCantar.setEnabled(true);
    ...
    private void btnGenerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarActionPerformed
        try {
            ...
            int numeroGenerado = controlador.ObtenerUltNumero();
            
            if (numeroGenerado == -1) {
                javax.swing.JOptionPane.showMessageDialog(
                    this,"No hay más números disponibles en la tombola","Tombola vacía",
                        JOptionPane.INFORMATION_MESSAGE );
            }
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(
                this,"Error al generar número: " + e.getMessage(),"Error", JOptionPane.ERROR_MESSAGE );
        }
    }//GEN-LAST:event_btnGenerarActionPerformed

    private void btnCantarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCantarActionPerformed
        try {
            String texto = txtIngresarNumero.getText().trim();
            
            if (texto.isEmpty()) {
                javax.swing.JOptionPane.showMessageDialog(
                    this, "Por favor ingresa un número", "Campo requerido", JOptionPane.WARNING_MESSAGE);
                txtIngresarNumero.setEnabled(true);
            ...
            try {
                ...
                javax.swing.JOptionPane.showMessageDialog(
                    this, e.getMessage(),"Número ya utilizado", JOptionPane.WARNING_MESSAGE );
                txtIngresarNumero.setText("");
                txtIngresarNumero.setEnabled(true);
                txtIngresarNumero.requestFocus();
            }
    ...
    public void actualizarNumero(int numero) {
        ...
        // En modo manual, mantener habilitado el campo de entrada
        if (!controlador.esAutomatico()) {
            txtIngresarNumero.setEnabled(true);
            txtIngresarNumero.requestFocus();
        }
    }
